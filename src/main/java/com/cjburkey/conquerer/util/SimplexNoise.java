...
public final class SimplexNoise {  // Simplex noise in 2D, 3D and 4D
    ...
    static double noise(double xin, double yin) {
        ...
        long i = Util.floor(xin + s);
        long j = Util.floor(yin + s);
        double t = (i + j) * G2;
    ...
    public static double noise(double x, double y, double z, double w) {
        ...
        long i = Util.floor(x + s);
        long j = Util.floor(y + s);
        long k = Util.floor(z + s);
        long l = Util.floor(w + s);
